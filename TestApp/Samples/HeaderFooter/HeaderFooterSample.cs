...
namespace DocXStandard.Examples
{
  public class HeaderFooterSample
  {
    ...
    private static readonly string HeaderFooterSampleOutputDirectory = Program.SampleDirectory + @"HeaderFooter" + Path.DirectorySeparatorChar + "Output" + Path.DirectorySeparatorChar;
