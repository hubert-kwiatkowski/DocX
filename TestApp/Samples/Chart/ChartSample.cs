...
namespace DocXStandard.Examples
{
  public class ChartSample
  {
    ...
    private static readonly string ChartSampleOutputDirectory = Program.SampleDirectory + @"Chart" + Path.DirectorySeparatorChar + "Output" + Path.DirectorySeparatorChar;
