...
namespace DocXStandard.Examples
{
  public class EquationSample
  {
    ...
    private static readonly string EquationSampleOutputDirectory = Program.SampleDirectory + @"Equation" + Path.DirectorySeparatorChar + "Output" + Path.DirectorySeparatorChar;
