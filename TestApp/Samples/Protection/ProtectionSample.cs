...
namespace DocXStandard.Examples
{
  public class ProtectionSample
  {
    ...
    private static readonly string ProtectionSampleOutputDirectory = Program.SampleDirectory + @"Protection" + Path.DirectorySeparatorChar + "Output" + Path.DirectorySeparatorChar;
