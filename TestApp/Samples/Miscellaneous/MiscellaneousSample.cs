...
namespace DocXStandard.Examples
{
  public class MiscellaneousSample
  {
    ...
    private static readonly string MiscellaneousSampleResourcesDirectory = Program.SampleDirectory + @"Miscellaneous" + Path.DirectorySeparatorChar + "Resources" + Path.DirectorySeparatorChar;
    private static readonly string MiscellaneousSampleOutputDirectory = Program.SampleDirectory + @"Miscellaneous" + Path.DirectorySeparatorChar + "Output" + Path.DirectorySeparatorChar;
