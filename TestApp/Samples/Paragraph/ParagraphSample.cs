...
namespace DocXStandard.Examples
{
  public class ParagraphSample
  {
    ...
    private static readonly string ParagraphSampleOutputDirectory = Program.SampleDirectory + "Paragraph" + Path.DirectorySeparatorChar + "Output" + Path.DirectorySeparatorChar;
