...
namespace DocXStandard.Examples
{
  public class HyperlinkSample
  {
    ...
    private static readonly string HyperlinkSampleOutputDirectory = Program.SampleDirectory + @"Hyperlink" + Path.DirectorySeparatorChar + "Output" + Path.DirectorySeparatorChar;
