...
namespace DocXStandard.Examples
{
  public class BookmarkSample
  {
    ...
    private static readonly string BookmarkSampleResourcesDirectory = Program.SampleDirectory + @"Bookmark" + Path.DirectorySeparatorChar + "Resources" + Path.DirectorySeparatorChar;
    private static readonly string BookmarkSampleOutputDirectory = Program.SampleDirectory + @"Bookmark" + Path.DirectorySeparatorChar + "Output" + Path.DirectorySeparatorChar;
