...
namespace DocXStandard.Examples
{
  public class ParallelSample
  {
    ...
    private static readonly string ParallelSampleResourcesDirectory = Program.SampleDirectory + "Parallel" + Path.DirectorySeparatorChar + "Resources" + Path.DirectorySeparatorChar;
    private static readonly string ParallelSampleOutputDirectory = Program.SampleDirectory + "Parallel" + Path.DirectorySeparatorChar + "Output" + Path.DirectorySeparatorChar;
