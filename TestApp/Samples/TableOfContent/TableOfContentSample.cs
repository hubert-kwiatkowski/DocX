...
namespace DocXStandard.Examples
{
  public class TableOfContentSample
  {
    ...
    private static readonly string TableOfContentSampleOutputDirectory = Program.SampleDirectory + @"TableOfContent" + +Path.DirectorySeparatorChar + "Output" + Path.DirectorySeparatorChar;
