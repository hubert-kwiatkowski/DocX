...
namespace DocXStandard.Examples
{
  public class SectionSample
  {
    ...
    private static readonly string SectionSampleOutputDirectory = Program.SampleDirectory + @"Section" + Path.DirectorySeparatorChar + "Output" + Path.DirectorySeparatorChar;
