...
namespace DocXStandard.Examples
{
  public class MarginSample
  {
    ...
    private static readonly string MarginSampleOutputDirectory = Program.SampleDirectory + @"Margin" + Path.DirectorySeparatorChar + "Output" + Path.DirectorySeparatorChar;
