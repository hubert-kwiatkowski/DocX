...
namespace DocXStandard.Examples
{
  public class TableSample
  {
    ...
    private static readonly string TableSampleResourcesDirectory = Program.SampleDirectory + @"Table" + Path.DirectorySeparatorChar + "Resources" + Path.DirectorySeparatorChar;
    private static readonly string TableSampleOutputDirectory = Program.SampleDirectory + @"Table" + Path.DirectorySeparatorChar + "Output" + Path.DirectorySeparatorChar;
