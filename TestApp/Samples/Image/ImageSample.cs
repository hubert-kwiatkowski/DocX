...
namespace DocXStandard.Examples
{
  public class ImageSample
  {
    ...
    private static readonly string ImageSampleResourcesDirectory = Program.SampleDirectory + @"Image" + Path.DirectorySeparatorChar + "Resources" + Path.DirectorySeparatorChar;
    private static readonly string ImageSampleOutputDirectory = Program.SampleDirectory + @"Image" + Path.DirectorySeparatorChar + "Output" + Path.DirectorySeparatorChar;
