...
namespace DocXStandard.Examples
{
  public class DocumentSample
  {
    ...
    private static readonly string DocumentSampleResourcesDirectory = Program.SampleDirectory + @"Document" + Path.DirectorySeparatorChar + "Resources" + Path.DirectorySeparatorChar; 
    private static readonly string DocumentSampleOutputDirectory = Program.SampleDirectory + @"Document" + Path.DirectorySeparatorChar + "Output" + Path.DirectorySeparatorChar;
