...
namespace DocXStandard{
  ...
  public class Formatting : IComparable
  {
    ...
    public Formatting()
    {
      _capsStyle = DocXStandard.CapsStyle.none;
      _strikethrough = DocXStandard.StrikeThrough.none;
      _script = DocXStandard.Script.none;
      _highlight = DocXStandard.Highlight.none;
      _underlineStyle = DocXStandard.UnderlineStyle.none;
      _misc = DocXStandard.Misc.none;
    ...
    internal XElement Xml
    {
      get
      {
        ...
        if( _underlineStyle.HasValue )
        {
          ...
          {
            case DocXStandard.UnderlineStyle.none:
              break;
            case DocXStandard.UnderlineStyle.singleLine:
              _rPr.Add( new XElement( XName.Get( "u", DocX.w.NamespaceName ), new XAttribute( XName.Get( "val", DocX.w.NamespaceName ), "single" ) ) );
              break;
            case DocXStandard.UnderlineStyle.doubleLine:
        ...
        if( _underlineColor.HasValue )
        {
          ...
          if( _underlineStyle == DocXStandard.UnderlineStyle.none )
          {
            // Set the underlineStyle to the default
            _underlineStyle = DocXStandard.UnderlineStyle.singleLine;
            _rPr.Add( new XElement( XName.Get( "u", DocX.w.NamespaceName ), new XAttribute( XName.Get( "val", DocX.w.NamespaceName ), "single" ) ) );
          }
        ...
        if( _strikethrough.HasValue )
        {
          ...
          {
            case DocXStandard.StrikeThrough.none:
              break;
            case DocXStandard.StrikeThrough.strike:
              _rPr.Add( new XElement( XName.Get( "strike", DocX.w.NamespaceName ) ) );
              break;
            case DocXStandard.StrikeThrough.doubleStrike:
        ...
        if( _highlight.HasValue )
        {
          switch( _highlight )
          {
            case DocXStandard.Highlight.none:
              break;
            default:
        ...
        if( _capsStyle.HasValue )
        {
          switch( _capsStyle )
          {
            case DocXStandard.CapsStyle.none:
              break;
            default:
      ...
      foreach( XElement option in rPr.Elements() )
      {
        switch( option.Name.LocalName )
        {
          ...
          case "highlight":
            ...
            {
              case "yellow":
                formatting.Highlight = DocXStandard.Highlight.yellow;
                break;
              case "green":
                formatting.Highlight = DocXStandard.Highlight.green;
                break;
              case "cyan":
                formatting.Highlight = DocXStandard.Highlight.cyan;
                break;
              case "magenta":
                formatting.Highlight = DocXStandard.Highlight.magenta;
                break;
              case "blue":
                formatting.Highlight = DocXStandard.Highlight.blue;
                break;
              case "red":
                formatting.Highlight = DocXStandard.Highlight.red;
                break;
              case "darkBlue":
                formatting.Highlight = DocXStandard.Highlight.darkBlue;
                break;
              case "darkCyan":
                formatting.Highlight = DocXStandard.Highlight.darkCyan;
                break;
              case "darkGreen":
                formatting.Highlight = DocXStandard.Highlight.darkGreen;
                break;
              case "darkMagenta":
                formatting.Highlight = DocXStandard.Highlight.darkMagenta;
                break;
              case "darkRed":
                formatting.Highlight = DocXStandard.Highlight.darkRed;
                break;
              case "darkYellow":
                formatting.Highlight = DocXStandard.Highlight.darkYellow;
                break;
              case "darkGray":
                formatting.Highlight = DocXStandard.Highlight.darkGray;
                break;
              case "lightGray":
                formatting.Highlight = DocXStandard.Highlight.lightGray;
                break;
              case "black":
                formatting.Highlight = DocXStandard.Highlight.black;
                break;
            }
            break;
          case "strike":
            formatting.StrikeThrough = DocXStandard.StrikeThrough.strike;
            break;
          case "dstrike":
            formatting.StrikeThrough = DocXStandard.StrikeThrough.doubleStrike;
            break;
          case "u":
          ...
          case "vertAlign": //script
            ...
            break;
          case "caps":
            formatting.CapsStyle = DocXStandard.CapsStyle.caps;
            break;
          case "smallCaps":
            formatting.CapsStyle = DocXStandard.CapsStyle.smallCaps;
            break;
          case "shd":
