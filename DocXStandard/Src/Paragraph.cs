...
namespace DocXStandard
{
  ...
  public class Paragraph : InsertBeforeOrAfter
  {
    ...
    public Alignment Alignment
    {
      get
      {
        ...
        if( jc != null )
        {
          ...
          {
            case "left":
              return DocXStandard.Alignment.left;
            case "right":
              return DocXStandard.Alignment.right;
            case "center":
              return DocXStandard.Alignment.center;
            case "both":
              return DocXStandard.Alignment.both;
          }
        }
      ...
      set
      {
        ...
        if( alignment != DocXStandard.Alignment.left )
        {
          if( jc == null )
    ...
    //     DocXStandard.Image img = document.AddImage(@"Image.jpg");
    //
    ...
    /// <summary>
    /// Inserts a specified instance of System.String into a DocXStandard.DocX.Paragraph at a specified index position.
    /// </summary>
    /// <example>
    /// <code> 
    /// // Create a document using a relative filename.
    ...
    ///
    ///    // Add an Image to this document.
    ///    DocXStandard.Image img = document.AddImage(directory_documents + "purple.png");
    ///
    ...
    /// <summary>
    /// Removes characters from a DocXStandard.DocX.Paragraph.
    /// </summary>
    /// <example>
    /// <code>
    /// // Create a document using a relative filename.
