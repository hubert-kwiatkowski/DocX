...
namespace DocXStandard
{
    ...
    public class DocX : Container, IDisposable
    {
        ...
        public bool DifferentOddAndEvenPages
        {
            ...
            {
                XDocument settings;
                using (Stream s = _settingsPart.GetStream())
        ...
        /// foreach (DocXStandard.Image i in document.Images)
        /// {
        ...
        public Dictionary<string, CustomProperty> CustomProperties
        {
            get
            {
                if (_package.PartExists(new Uri("/docProps/custom.xml", UriKind.Relative)))
                {
                    ...
                    using (Stream s = docProps_custom.GetStream(FileMode.Open, FileAccess.Read))
                    using (TextReader tr = new StreamReader(s))
        ...
        public Dictionary<string, string> CoreProperties
        {
            get
            {
                if (_package.PartExists(new Uri("/docProps/core.xml", UriKind.Relative)))
                {
                    ...
                    using (Stream s = docProps_Core.GetStream(FileMode.Open, FileAccess.Read))
                    using (TextReader tr = new StreamReader(s))
                ...
                else
                {
                    ...
                    switch (remote_pp.ContentType)
                    {
                        ...
                        case "application/vnd.openxmlformats-officedocument.wordprocessingml.styles+xml":
                            ...
                            using (Stream s = _stylesPart.GetStream())
                            using (TextReader tr = new StreamReader(s))
                        ...
                        case "application/vnd.ms-word.stylesWithEffects+xml":
                            ...
                            using (Stream s = _stylesWithEffectsPart.GetStream())
                            using (TextReader tr = new StreamReader(s))
                        ...
                        case "application/vnd.openxmlformats-officedocument.wordprocessingml.fontTable+xml":
                            ...
                            using (Stream s = _fontTablePart.GetStream())
                            using (TextReader tr = new StreamReader(s))
                        ...
                        case "application/vnd.openxmlformats-officedocument.wordprocessingml.numbering+xml":
                            ...
                            using (Stream s = _numberingPart.GetStream())
                            using (TextReader tr = new StreamReader(s))
        ...
        public void ApplyTemplate(Stream templateStream, bool includeContent)
        {
            ...
            try
            {
                ...
                foreach (PackagePart packagePart in templatePackage.GetParts())
                {
                    switch (packagePart.Uri.ToString())
                    {
                        case "/word/document.xml":
                            ...
                            using (Stream s = packagePart.GetStream(FileMode.Open, FileAccess.Read))
                        ...
                        case "/_rels/.rels":
                            ...
                            using (Stream s2 = globalRelsPart.GetStream(FileMode.Create, FileAccess.Write))
                            using (PackagePartStream pps = new PackagePartStream(s2))
                        ...
                        default:
                            ...
                            using (Stream s = packagePart.GetStream(FileMode.Open, FileAccess.Read))
                            using (var tr = new StreamReader(s, packagePartEncoding))
                            using (Stream s2 = nativePart.GetStream(FileMode.Create, FileAccess.Write))
                            using (PackagePartStream pps = new PackagePartStream(s2))
                            using (var tw = new StreamWriter(pps, tr.CurrentEncoding))
                            {
                                tw.Write(tr.ReadToEnd());
                            }
                ...
                if (documentPart != null)
                {
                    ...
                    using (Stream s = documentNewPart.GetStream(FileMode.Create, FileAccess.Write))
                    using (PackagePartStream pps = new PackagePartStream(s))
                    using (XmlWriter xw = XmlWriter.Create(pps))
                    {
            ...
            finally
            {
                ...
                using (Stream s = documentRelsPart.GetStream(FileMode.Open, FileAccess.Read))
                using (TextReader tr = new StreamReader(s))
                {
                    tr.Read();
                }*/
        ...
        public void Save()
        {
            ...
            using (Stream s = this.PackagePart.GetStream(FileMode.Create, FileAccess.Write))
            using (PackagePartStream pps = new PackagePartStream(s))
            using (TextWriter tw = new StreamWriter(pps))
            {
            ...
            if (sectPr != null)
            {
                ...
                if (evenHeaderRef != null)
                {
                    ...
                    using (Stream s = _package.GetPart(target).GetStream(FileMode.Create, FileAccess.Write))
                    using (PackagePartStream pps = new PackagePartStream(s))
                    using (TextWriter tw = new StreamWriter(pps))
                    {
                        new XDocument
                ...
                using (Stream s = _settingsPart.GetStream(FileMode.Create, FileAccess.Write))
                using (PackagePartStream pps = new PackagePartStream(s))
                using (TextWriter tw = new StreamWriter(pps))
                {
                ...
                {
                    using (Stream s = _endnotesPart.GetStream(FileMode.Create, FileAccess.Write))
                    using (PackagePartStream pps = new PackagePartStream(s))
                    using (TextWriter tw = new StreamWriter(pps))
                    {
                ...
                {
                    using (Stream s = _footnotesPart.GetStream(FileMode.Create, FileAccess.Write))
                    using (PackagePartStream pps = new PackagePartStream(s))
                    using (TextWriter tw = new StreamWriter(pps))
                    {
                ...
                if (_stylesPart != null)
                {
                    using (Stream s = _stylesPart.GetStream(FileMode.Create, FileAccess.Write))
                    using (PackagePartStream pps = new PackagePartStream(s))
                    using (TextWriter tw = new StreamWriter(pps))
                    {
                ...
                {
                    using (Stream s = _stylesWithEffectsPart.GetStream(FileMode.Create, FileAccess.Write))
                    using (PackagePartStream pps = new PackagePartStream(s))
                    using (TextWriter tw = new StreamWriter(pps))
                    {
                ...
                {
                    using (Stream s = _fontTablePart.GetStream(FileMode.Create, FileAccess.Write))
                    using (PackagePartStream pps = new PackagePartStream(s))
                    using (TextWriter tw = new StreamWriter(pps))
                    {
        ...
        public void AddCoreProperty(string propertyName, string propertyValue)
        {
            ...
            using (Stream s = corePropPart.GetStream(FileMode.Open, FileAccess.Read))
            using (TextReader tr = new StreamReader(s))
            {
            ...
            using (Stream s = corePropPart.GetStream(FileMode.Create, FileAccess.Write))
            using (PackagePartStream pps = new PackagePartStream(s))
            using (TextWriter tw = new StreamWriter(pps))
            {
                corePropDoc.Save(tw);
        ...
        public void AddCustomProperty(CustomProperty cp)
        {
            ...
            using (Stream s = customPropPart.GetStream(FileMode.Open, FileAccess.Read))
            using (TextReader tr = new StreamReader(s))
            {
                customPropDoc = XDocument.Load(tr, LoadOptions.PreserveWhitespace);
            }
            ...
            using (Stream s = customPropPart.GetStream(FileMode.Create, FileAccess.Write))
            using (PackagePartStream pps = new PackagePartStream(s))
            using (TextWriter tw = new StreamWriter(pps))
            {
        ...
        private void InsertChart(Chart chart, Paragraph paragraph)
        {
            ...
            if (paragraph == null)
            {
                using (Stream s = chartPackagePart.GetStream(FileMode.Create, FileAccess.Write))
                using (PackagePartStream pps = new PackagePartStream(s))
                using (TextWriter tw = new StreamWriter(pps))
                {
                    chart.Xml.Save(tw);
        ...
        internal static void PostCreation(Package package, DocumentTypes documentType = DocumentTypes.Document)
        {
            ...
            using (Stream s = mainDocPart.GetStream(FileMode.Create, FileAccess.ReadWrite))
            using (TextReader tr = new StreamReader(s))
            {
            ...
            // Save the main document
            using (Stream s = mainDocPart.GetStream(FileMode.Create, FileAccess.Write))
            using (PackagePartStream pps = new PackagePartStream(s))
            using (TextWriter tw = new StreamWriter(pps))
            {
        ...
        internal static DocX PostLoad(ref Package package)
        {
            ...
            using (Stream s = document.PackagePart.GetStream(FileMode.Open, FileAccess.Read))
            using (TextReader tr = new StreamReader(s))
            {
            ...
            using (Stream s = document._settingsPart.GetStream())
            using (TextReader tr = new StreamReader(s))
            {
        ...
        internal void AddHyperlinkStyleIfNotPresent()
        {
            ...
            using (Stream s = _package.GetPart(word_styles_Uri).GetStream())
            using (TextReader tr = new StreamReader(s))
            {
        ...
        internal void AddHeadersOrFooters(bool b)
        {
            ...
            for (int i = 1; i < 4; i++)
            {
                ...
                // Load the document part into a XDocument object
                using (Stream s = headerPart.GetStream(FileMode.Create, FileAccess.ReadWrite))
                using (TextReader tr = new StreamReader(s))
                {
                ...
                // Save the main document
                using (Stream s = headerPart.GetStream(FileMode.Create, FileAccess.Write))
                using (PackagePartStream pps = new PackagePartStream(s))
                using (TextWriter tw = new StreamWriter(pps))
                {
        ...
        internal Image AddImage(object o, string contentType = "image/jpeg")
        {
            ...
            foreach (PackagePart relsPart in relsParts)
            {
                ...
                using (Stream s = relsPart.GetStream(FileMode.Open, FileAccess.Read))
                using (TextReader tr = new StreamReader(s))
                {
                ...
                foreach (XElement imageRelationship in imageRelationships)
                {
                    ...
                    if (attribute != null)
                    {
                        ...
                        if (!targetMode.Equals("External"))
                        {
                            ...
                            imagePartUri = Path.GetFullPath(imagePartUri.Replace(Path.DirectorySeparatorChar + "_rels", string.Empty));
            ...
            using (Stream s = img.GetStream(FileMode.Create, FileAccess.Write))
            using (Stream stream = new PackagePartStream(s))
            {
        ...
        internal static void UpdateCorePropertyValue(DocX document, string corePropertyName, string corePropertyValue)
        {
            ...
            foreach (XElement e in document._mainDoc.Descendants(XName.Get("fldSimple", w.NamespaceName)))
            {
                ...
                if (Regex.IsMatch(attr_value, matchPattern))
                {
                    ...
                    DocXStandard.Text.PreserveSpace(t);
            ...
            foreach (PackagePart pp in headerParts)
            {
                ...
                using (Stream s = pp.GetStream(FileMode.Create, FileAccess.Write))
                using (PackagePartStream pps = new PackagePartStream(s))
                using (TextWriter tw = new StreamWriter(pps))
                {
                    header.Save(tw);
        ...
        internal XDocument AddStylesForList()
        {
            ...
            XDocument stylesDoc;
            using (Stream s = _package.GetPart(fileUri).GetStream())
            using (TextReader tr = new StreamReader(s))
        ...
        private void merge_images(PackagePart remote_pp, DocX remote_document, XDocument remote_mainDoc, String contentType)
        {
            ...
            string remote_hash;
            using (Stream s = remote_pp.GetStream())
            remote_hash = this.ComputeMD5HashString(s);
            ...
            foreach (var part in image_parts)
            {
                string local_hash;
                using (Stream s = part.GetStream())
                local_hash = ComputeMD5HashString(s);
            ...
            if (!found)
            {
                ...
                {
                    using (Stream s = new_pp.GetStream(FileMode.Create))
                    using (Stream s_write = new PackagePartStream(s))
                    {
        ...
        private void merge_customs(PackagePart remote_pp, PackagePart local_pp, XDocument remote_mainDoc)
        {
            ...
            using (Stream s = local_pp.GetStream())
            using (TextReader tr = new StreamReader(s))
            {
            ...
            using (Stream s = local_pp.GetStream(FileMode.Create, FileAccess.Write))
            using (PackagePartStream pps = new PackagePartStream(s))
            using (TextWriter tw = new StreamWriter(pps))
            {
            ...
            foreach (var rel in document.PackagePart.GetRelationships())
            {
                ...
                switch (rel.RelationshipType)
                {
                    case "http://schemas.openxmlformats.org/officeDocument/2006/relationships/endnotes":
                        ...
                        using (Stream s = document._endnotesPart.GetStream())
                        using (TextReader tr = new StreamReader(s))
                    ...
                    case "http://schemas.openxmlformats.org/officeDocument/2006/relationships/footnotes":
                        ...
                        using (Stream s = document._footnotesPart.GetStream())
                        using (TextReader tr = new StreamReader(s))
                    ...
                    case "http://schemas.openxmlformats.org/officeDocument/2006/relationships/styles":
                        ...
                        using (Stream s = document._stylesPart.GetStream())
                        using (TextReader tr = new StreamReader(s))
                    ...
                    case "http://schemas.microsoft.com/office/2007/relationships/stylesWithEffects":
                        ...
                        using (Stream s = document._stylesWithEffectsPart.GetStream())
                        using (TextReader tr = new StreamReader(s))
                    ...
                    case "http://schemas.openxmlformats.org/officeDocument/2006/relationships/fontTable":
                        ...
                        using (Stream s = document._fontTablePart.GetStream())
                        using (TextReader tr = new StreamReader(s))
                    ...
                    case "http://schemas.openxmlformats.org/officeDocument/2006/relationships/numbering":
                        ...
                        using (Stream s = document._numberingPart.GetStream())
                        using (TextReader tr = new StreamReader(s))
